...
public class OurAudioPinApi {
     ...
     */
    public static OurAudioPinApi getInstance(){
    ...
    public Call<Object> authToken(AuthRequest authRequest){
        return mApiService.authToken(authRequest);
    }
    ...
    public Call<ResponseBody> uploadEnrollmentAudio(String token, String clientId,
        ...
        return mApiService.uploadEnrollmentAudio(token, clientId, animationStart, intervals, body, filename);
    }

    private static class AudioPinApiHolder {
        public static final OurAudioPinApi instance = new OurAudioPinApi();
    }
